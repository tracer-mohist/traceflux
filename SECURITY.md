...
**Alternative**: If GitHub security advisories are unavailable, open a regular issue and mark it as security-related in the title: `[SECURITY] Description`

### What to Include

To help us understand and fix the vulnerability quickly:
...
**What traceflux is protected against**:
...
**What traceflux is NOT protected against**:
